...
// 例: const GADS_CONVERSION = "AW-XXXXXXXXX/XXXXXXXXXXXXXXXXXXXX";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateResult() {
    ...
    if (count === 0) {
      ...
      resultText.textContent = "1件チェック：ネズミがいる可能性があります。早めの確認がおすすめです";
      if (symptomCta) symptomCta.textContent = "この症状を無料で調査してもらう";
    } else {
      resultBox.className = "check-result is-alert";
      resultText.textContent = count + "件チェック：住み着いている可能性が高い状態です。被害が広がる前の相談をおすすめします";
