...
|--------|------|------|
| 無料体験レッスン | 0円（45分） | 無料 |
| はじめてプラン【月4時間】 | 26,400円（税込）※税抜24,000円 | 月額・おすすめ |
| 徹底プラン【月8時間】 | 44,880円（税込）※税抜40,800円 | 月額（折りたたみ） |
| ライトプラン【月2時間】 | 14,300円（税込）※税抜13,000円 | 月額（折りたたみ） |
| 単発集中プラン【1回90分】 | 11,000円（税込）※税抜10,000円 | 単発・直前対策向け |
| 単発プラン【1回60分】 | 7,700円（税込）※税抜7,000円 | 単発・入門向け |

LP上の表示：
- メイン表示（3カード）：無料体験・はじめてプラン・単発集中プラン・単発プラン
- 折りたたみ表示：徹底プラン・ライトプラン
...
最新コミット（071d8f3）：
Improve ad readiness pricing form UX and design polish（第3版 広告出稿前改善）

その前（df218ef）：
Update handoff memo with latest LP status
...
| 項目 | 現状 | 対応 |
|------|------|------|
| LINEリンク | 全箇所 `is-hidden-until-line-ready` で非表示中 | LINE公式開設後、正式URLに差し替え＋非表示クラス除去 |
| フォーム送信先 | `action="https://formspree.io/f/YOUR_FORM_ID"`（仮ID） | Formspreeで本登録し form ID を差し替え |
| お客様の声3件 | 仮テキスト・セクションごと非表示中 | 実際の声に差し替え後 `is-hidden-until-ready` を除去 |
| 受講者アバター写真 | プレースホルダー（非表示中） | images/voice-01〜03.jpg を用意 |

### 第4版（2026年6月）で確定・解消した項目

- お支払い方法：現金・クレジットカード（確定）
- キャンセル規定：記載なし方針（本文・FAQ・特商法から削除済み）
- 国分寺教室 最寄駅：国分寺駅 北口 徒歩2分／八王子教室 最寄駅：八王子駅 北口 徒歩4分
- 画像：全プレースホルダーを実画像に差し替え（元画像は `デスクトップ/hanasikataLP/`）
- `privacy.html` / `commercial-law.html` を作成・フッターからリンク済み
- 電話番号：LPには非掲載（方針どおり）
- FVバッジ「無料体験 30分」＋補足「30分＋料金・システム説明15分」
- CTAはフォーム予約に一本化（LINE導線は全て非表示）
